...
class CreateTrip1 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      edit: false,
      ...
      <div>
        {this.state.edit === false ? null : (
          <div className="searchBox">
            <CreateTripSearch source='createTripContainer' addDestination={this.searchNewPlace} />
...
export default connect(mapStateToProps, { createNewTrip })(CreateTrip1);
